  ...
  return (
      <div className="flex items-center justify-between p-3 bg-gray-100 rounded-lg shadow-md ">
        ...
        <div className="flex items-center gap-1">
            <a href="/daily-schedule" className="flex items-center gap-2 bg-indigo-600 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded transition-colors">
            ...
            <a href="/timetable" className="flex items-center gap-2 bg-blue-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition-colors ml-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
